...
@Component({
  selector: 'app-liberar-adeudos-docencia',
  templateUrl: './liberar-adeudos-docencia.component.html',
  styleUrls: ['./liberar-adeudos-docencia.component.css']
})
//@CanActivate(() => Seguridad.isLoggedIn())
export class LiberarAdeudosDocenciaComponent implements OnInit {
...
//    let params = _router.parent.currentInstruction.component.params;
    ...
    this.formularioCheck = new FormGroup({
     ...
     if (sessionStorage.getItem('liberarIdPromocion')) {
      let promocion = 'idPromocion';
    }

    if (sessionStorage.getItem('liberarCriterios')) {
      this.onCambiosTabla();
    }
  }
  ...
  buscarCriteriosCabezera(
   ...
   this.limpiarVariablesSession();
    ...
    sessionStorage.setItem('liberarIdPromocion', idPromocion.toString());
    sessionStorage.setItem('liberarIdEstatus', idEstatus.toString()); 
    this.onCambiosTabla();
  }
  ...
  onCambiosTabla(): void {
    ...
    sessionStorage.setItem('liberarCriterios', criterios);
    sessionStorage.setItem('liberarOrdenamiento', ordenamiento);
    sessionStorage.setItem('liberarLimite', this.limite.toString());
    sessionStorage.setItem('liberarPagina', this.paginaActual.toString());

    }

    this.limite = +sessionStorage.getItem('liberarLimite') ? +sessionStorage.getItem('liberarLimite') : this.limite;
    this.paginaActual = +sessionStorage.getItem('liberarPagina') ? +sessionStorage.getItem('liberarPagina') : this.paginaActual;
    urlSearch.set('criterios', sessionStorage.getItem('liberarCriterios')
    ? sessionStorage.getItem('liberarCriterios') : criterios);
    urlSearch.set('ordenamiento', sessionStorage.getItem('liberarOrdenamiento') ? sessionStorage.getItem('liberarOrdenamiento') : ordenamiento);
...
//  constructor() { }
  ...
  limpiarVariablesSession() {
    sessionStorage.removeItem('liberarCriterios');
    sessionStorage.removeItem('liberarOrdenamiento');
    sessionStorage.removeItem('liberarLimite');
    sessionStorage.removeItem('liberarPagina');
  }
