...
@Component({
  selector: 'app-evaluacion-parte-dos',
  templateUrl: './evaluacion-parte-dos.component.html',
  styleUrls: ['./evaluacion-parte-dos.component.css']
})
export class EvaluacionParteDosComponent implements OnInit {
  errorNext: string = '';
  id: string;
  pregunta5;
  pregunta6;
