...
@Component({
  selector: 'app-induccion-biblioteca',
  templateUrl: './induccion-biblioteca.component.html',
  styleUrls: ['./induccion-biblioteca.component.css']
})
export class InduccionBibliotecaComponent {
  ...
  constructor(// private modal: Modal,
    ...
    (<FormControl>this.formularioRegistroPagina.controls['registroPorPagina'])
      .setValue(+sessionStorage.getItem('induccionBibliotecaLimite') ? +sessionStorage.getItem('induccionBibliotecaLimite') : this.limite);
  ...
  onCambiosTabla(): void {
    ...
    if (!sessionStorage.getItem('induccionBibliotecaOrdenamiento')) {
      ...
      sessionStorage.setItem('induccionBibliotecaOrdenamiento', ordenamiento);
    }
    if (!sessionStorage.getItem('induccionBibliotecaCriterios')) {
      sessionStorage.setItem('induccionBibliotecaCriterios', criterios);
    }
    this.limite = +sessionStorage.getItem('induccionBibliotecaLimite') ? +sessionStorage.getItem('induccionBibliotecaLimite') : this.limite;
    this.paginaActual = +sessionStorage.getItem('induccionBiblbiotecaPagina') ?
      +sessionStorage.getItem('induccionBiblbiotecaPagina') : this.paginaActual;

    urlSearch.set('criterios', sessionStorage.getItem('induccionBibliotecaCriterios'));
    urlSearch.set('ordenamiento', sessionStorage.getItem('induccionBibliotecaOrdenamiento'));
   urlSearch.set('limit', this.limite.toString());
   urlSearch.set('pagina', this.paginaActual.toString());

    // console.log("urlSearch",urlSearch);
    this.spinner.start('induccionbiblioteca1');
...
/*        if (assertionsEnabled()) {
        ...
        this.spinner.stop('induccionbiblioteca1');
      },
      () => {
/*        if (assertionsEnabled()) {
  ...
  sortChanged(columna): void {
    sessionStorage.removeItem('induccionBibliotecaOrdenamiento');
  ...
  setLimite(limite: string): void {
    sessionStorage.removeItem('induccionBibliotecaLimite');
    this.limite = Number(limite);
    sessionStorage.setItem('induccionBibliotecaLimite', this.limite.toString());
    this.onCambiosTabla();
  }
  ...
  cambiarPagina(evento: any): void {
    sessionStorage.removeItem('induccionBiblbiotecaPagina');
    this.paginaActual = evento.page;
    sessionStorage.setItem('induccionBiblbiotecaPagina', this.paginaActual.toString());
  ...
  limpiarVariablesSession() {
    sessionStorage.removeItem('induccionBibliotecaCriterios');
    sessionStorage.removeItem('induccionBibliotecaOrdenamiento');
    sessionStorage.removeItem('induccionBibliotecaLimite');
    sessionStorage.removeItem('induccionBibliotecaPagina');
  }
