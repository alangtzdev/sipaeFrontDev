...
@Component({
  selector: 'app-induccion-docencia',
  templateUrl: './induccion-docencia.component.html',
  styleUrls: ['./induccion-docencia.component.css']
})
export class InduccionDocenciaComponent {
  ...
  columnas: Array<any> = [
    ...
    { titulo: '*Área que va impartir el curso', nombre: 'idTipo.valor' },
  ...
  public configuracion: any = {
    paginacion: true,
    filtrado: { textoFiltro: '', columnas: 'idSala.descripcion,idTipo.valor', textoFecha: '' }
  };
  ...
  constructor(// private modal: Modal,
    ...
    if (sessionStorage.getItem('induccionDocenciaIdPromocion')) {
      let promocion = 'idPromocion';
    }

    if (sessionStorage.getItem('induccionDocenciaCriterios')) {
      this.onCambiosTabla();
    }
  }
  ...
  onCambiosTabla(): void {
    ...
    sessionStorage.setItem('induccionDocenciaCriterios', criterios);
    sessionStorage.setItem('induccionDocenciaOrdenamiento', ordenamiento);
    sessionStorage.setItem('induccionDocenciaLimite', this.limite.toString());
    sessionStorage.setItem('induccionDocenciaPagina', this.paginaActual.toString());
    }
    this.limite = +sessionStorage.getItem('induccionDocenciaLimite') ? +sessionStorage.getItem('induccionDocenciaLimite') : this.limite;
    this.paginaActual = +sessionStorage.getItem('induccionDocenciaPagina') ? +sessionStorage.getItem('induccionDocenciaPagina') : this.paginaActual;
    urlSearch.set('criterios', sessionStorage.getItem('induccionDocenciaCriterios') ? sessionStorage.getItem('induccionDocenciaCriterios') : criterios);
    urlSearch.set('ordenamiento', sessionStorage.getItem('induccionDocenciaOrdenamiento') ? sessionStorage.getItem('induccionDocenciaOrdenamiento') : ordenamiento);
  ...
  sortChanged(columna): void {
    ...
    if (columna.sort !== false) {
      ...
      this.spinner.start('inducciondocencia2');
      this.onCambiosTabla();
    }
  }
  ...
  mostrarBotonEditar(): boolean {
    if (this.registroSeleccionado) {
      if (this.registroSeleccionado.tipo.valor === 'Docencia') {
        return true;
      }
      return false;
    }
...
////////////////////////////////////////// MODAL CREAR / EDITAR LISTA DE ASISTENCIA////////////////////////////*****
  ...
  agregarEstudiante(): void {
    if (this.estudianteSelAutocomplete) {
      ...
      /*let asistente = new EstudianteListaAsistencia(false);
  ...
  limpiarVariablesSession() {
    sessionStorage.removeItem('induccionDocenciaCriterios');
    sessionStorage.removeItem('induccionDocenciaOrdenamiento');
    sessionStorage.removeItem('induccionDocenciaLimite');
    sessionStorage.removeItem('induccionDocenciaPagina');
  }
