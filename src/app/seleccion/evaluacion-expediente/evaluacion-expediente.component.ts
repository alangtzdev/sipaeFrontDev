...
@Component({
  selector: 'app-evaluacion-expediente',
  templateUrl: './evaluacion-expediente.component.html',
  styleUrls: ['./evaluacion-expediente.component.css']
})
export class EvaluacionExpedienteComponent implements OnInit {
  ...
  regresarListaSolicitantes(): any {
    this._router.navigate(['seleccion', 'evaluacion-aspirante']);
  }
