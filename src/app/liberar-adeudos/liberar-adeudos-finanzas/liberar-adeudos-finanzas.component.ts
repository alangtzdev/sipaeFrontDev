...
@Component({
  selector: 'app-liberar-adeudos-finanzas',
  templateUrl: './liberar-adeudos-finanzas.component.html',
  styleUrls: ['./liberar-adeudos-finanzas.component.css']
})
export class LiberarAdeudosFinanzasComponent implements OnInit {
