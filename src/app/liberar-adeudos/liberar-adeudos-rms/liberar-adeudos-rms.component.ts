...
@Component({
  selector: 'app-liberar-adeudos-rms',
  templateUrl: './liberar-adeudos-rms.component.html',
  styleUrls: ['./liberar-adeudos-rms.component.css']
})
export class LiberarAdeudosRmsComponent implements OnInit {
