...
@Component({
  selector: 'app-liberar-adeudos-utic',
  templateUrl: './liberar-adeudos-utic.component.html',
  styleUrls: ['./liberar-adeudos-utic.component.css']
})
export class LiberarAdeudosUticComponent implements OnInit {
